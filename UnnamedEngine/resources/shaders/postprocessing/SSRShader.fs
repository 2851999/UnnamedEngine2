...
layout(set = 3, binding = 0) uniform sampler2D ue_gPosition;
layout(set = 3, binding = 1) uniform sampler2D ue_gNormal;
layout(set = 3, binding = 2) uniform sampler2D ue_gAlbedo;
