...
const Colour Colour::BROWN      = Colour(0.6470588235294117f, 0.1647058823529411f, 0.1647058823529411f);
const Colour Colour::YELLOW     = Colour(1.0f, 1.0f, 0.0f, 1.0f);
const Colour Colour::PINK       = Colour(1.0f, 0.0f, 1.0f, 1.0f);
const Colour Colour::PURPLE     = Colour(0.5019607843137254f, 0, 0.5019607843137254f, 1.0f);
