...
void DescriptorSet::bind() {
    ...
    if (BaseEngine::usingVulkan())
        ...
        vkCmdBindDescriptorSets(Vulkan::getCurrentCommandBuffer(), VK_PIPELINE_BIND_POINT_GRAPHICS, Vulkan::getCurrentGraphicsPipeline()->getLayout(), layout->getSetNumber(), 1, &vulkanDescriptorSets[Vulkan::getCurrentFrame()], 0, nullptr);
    else {
