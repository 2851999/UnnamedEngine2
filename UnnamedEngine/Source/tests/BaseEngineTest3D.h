...
void Test::onCreated() {
	...
	GameObject3D* teapot = new GameObject3D(resourceLoader.loadModel("teapot.obj"), Renderer::getRenderShader("Lighting"));
	GameObject3D* plane = new GameObject3D(resourceLoader.loadModel("plane/", "plane.obj"), Renderer::getRenderShader("Lighting"));
